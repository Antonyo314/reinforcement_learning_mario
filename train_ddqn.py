...
class Agent:
    def __init__(self, action_space_dim, level):
        ...
        self.save_dir = datetime.datetime.now().strftime('%Y-%m-%dT%H-%M-%S')+f'_{level}'
...
if __name__ == '__main__':
    ...
    log_period_ = 1
    agent = Agent(action_space_dim=env.action_space.n, level=level)
